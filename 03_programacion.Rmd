...
Esto occurre porque por defecto esta función asume que tus datos tienen un encabezado.
Es decir, el parámetro llamado "header" esta seteado en TRUE, que significa que la función espera un encabezado.
